...
public class WeaponComponent : Component {
    ...
    [Sync, Property] public int CurrentMagazine {
        get => Math.Clamp(_magazine, 0, Weapon.Magazine);
        set => _magazine = value;
    }
    
    private int _reserve = 0;
    [Sync, Property] public int CurrentReserve {
    ...
    [Sync, Property] public GameObject CurrentProjectile { get; set; }
    ...
    protected override void OnAwake() {
        ...
        CurrentProjectile =  SceneUtility.GetPrefabScene( Weapon.Projectile );
    }
    ...
    public bool Fire() {
        ...
        var projectile = CurrentProjectile.Clone(EyePos.Transform.Position);
    ...
    private void ShootProjectile(Vector3 impactPos) { 
	    var projectile = CurrentProjectile.Clone( impactPos );
	    projectile.NetworkSpawn();
    }
